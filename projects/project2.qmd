...
```{r, eval=TRUE}
download.file(
  url = "https://single-cell-transcriptomics.s3.eu-central-1.amazonaws.com/projects/data/project2.tar.gz",
  destfile = "project2.tar.gz"
)
untar("project2.tar.gz")

file.remove("project2.tar.gz")
```
