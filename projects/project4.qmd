...
```{r, eval=TRUE}
download.file(
  url = "https://single-cell-transcriptomics.s3.eu-central-1.amazonaws.com/projects/data/project4.tar.gz",
  destfile = "project4.tar.gz"
)
untar("project4.tar.gz")

file.remove("project4.tar.gz")
```
