...
The following questions may be used to guide your analyses. 

### Quality control and filtering

- How many cells are there in the data set (raw data)?
- Is there evidence of dying cells? If so, how can you filter out dying cells?
...
- Do you think paper 1 or paper 2 chose a better threshold for mitochondrial percentage?
...
- Which marker genes could we use for annotation?
- Which clusters can you clearly identify using these markers genes?

####  Bonus questions (advanced)
- If we didn’t have such a list of marker genes, which other techniques could we try?
