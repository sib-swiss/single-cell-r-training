...
{{< downloadthis ../assets/pdf/SIB_NOV2025_SingleCell.pdf dname="01_introduction" label="Download the presentation" icon="filetype-pdf" >}}
...
## `R` Terminal
To download and extract the dataset, copy-paste these commands in the **Terminal** tab:
