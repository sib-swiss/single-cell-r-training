...
{{< downloadthis ../assets/pdf/10_CellAnnotation.pdf dname="10_CellAnnotation" label="Download the presentation" icon="filetype-pdf" >}}
...
```{r day3-1-cell-annotation-9}
Seurat::FeaturePlot(seu, monocyte_genes, ncol=2)
```

```{r day3-1-cell-annotation-10}
Seurat::VlnPlot(seu,
...
```{r day3-1-cell-annotation-19}
head(seu_SingleR)
```

Visualize singleR score quality scores:

```{r day3-1-cell-annotation-20}
SingleR::plotScoreHeatmap(seu_SingleR)
```

```{r day3-1-cell-annotation-21}
