...
- [Comparative analysis of gene ontology-based semantic similarity measurements](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0284274)

## Exercises

```{r day3-3-enrichment-analysis-1}
#| warning: false
#| message: false
...
```{r day3-3-enrichment-analysis-2}
#| warning: false
#| message: false
...
```{r day3-3-enrichment-analysis-3}
#| output: false
...
```{r day3-3-enrichment-analysis-4}
...
```{r day3-3-enrichment-analysis-5}
#| eval: false
?enrichGO
```

```{r day3-3-enrichment-analysis-6}
#| output: false
...
```{r day3-3-enrichment-analysis-7}
#| eval: false
View(tum_vs_norm_go@result)
```

```{r day3-3-enrichment-analysis-8}
#| echo: false
...
```{r day3-3-enrichment-analysis-9}
#| output: false
enr_go <- clusterProfiler::simplify(tum_vs_norm_go)
```

```{r day3-3-enrichment-analysis-10}
#| eval: false
View(enr_go@result)
```

```{r day3-3-enrichment-analysis-11}
#| echo: false
...
```{r day3-3-enrichment-analysis-12}
#| eval: false
...
```{r day3-3-enrichment-analysis-13}
library(msigdbr)
# library(msigdbdf)
...
```{r day3-3-enrichment-analysis-14}
#| output: false
...
```{r day3-3-enrichment-analysis-17}
#| eval: false
gc()
```
