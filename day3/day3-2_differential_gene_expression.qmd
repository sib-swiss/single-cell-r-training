...
{{< downloadthis ../assets/pdf/11_DEGs_and_Enrichment.pdf dname="11_DEGs_and_Enrichment" label="Download the presentation" icon="filetype-pdf" >}}
...
```{r day3-2-differential-gene-expression-1}
#| warning: false
#| message: false
...
```{r day3-2-differential-gene-expression-2}
#| warning: false
#| message: false
library(Seurat)
...
```{r day3-2-differential-gene-expression-3}
#| output: false
...
```{r day3-2-differential-gene-expression-4}
...
```{r day3-2-differential-gene-expression-5}
...
```{r day3-2-differential-gene-expression-6}
...
```{r day3-2-differential-gene-expression-7}
...
```{r day3-2-differential-gene-expression-8}
...
```{r day3-2-differential-gene-expression-9}
#| output: false
...
```{r day3-2-differential-gene-expression-10}
#| eval: false
View(deg_cd8_cd4)
```

```{r day3-2-differential-gene-expression-11}
#| echo: false
...
```{r day3-2-differential-gene-expression-12}
...
```{r day3-2-differential-gene-expression-13}
Seurat::VlnPlot(seu, 
...
```{r day3-2-differential-gene-expression-14}
...
```{r day3-2-differential-gene-expression-15}
...
```{r day3-2-differential-gene-expression-16}
#| output: false
...
```{r day3-2-differential-gene-expression-17}
...
```{r day3-2-differential-gene-expression-18}
...
```{r day3-2-differential-gene-expression-19}
...
```{r day3-2-differential-gene-expression-20}
...
```{r day3-2-differential-gene-expression-21}
...
```{r day3-2-differential-gene-expression-22}
...
```{r day3-2-differential-gene-expression-23}
#| message: false
...
```{r day3-2-differential-gene-expression-24}
library(ggplot2)
...
### MA plot
```{r day3-2-differential-gene-expression-25}
...
```{r day3-2-differential-gene-expression-26}
...
```{r day3-2-differential-gene-expression-27}
dim(tum_vs_norm_s) 
```
...
```{r day3-2-differential-gene-expression-28}
library(ggplot2)
...
```{r day3-2-differential-gene-expression-29}
...
```{r day3-2-differential-gene-expression-30}
#| echo: false
...
```{r day3-2-differential-gene-expression-31}
#| eval: false
gc()
```
