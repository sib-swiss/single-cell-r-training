...
```{r day2-4-clustering-6}
Seurat::DimPlot(seu, group.by = "RNA_snn_res.0.1")
```

We could also do it in 3D

```{r day2-4-clustering-7, warning=FALSE, message=FALSE}
library(plotly)
...
```{r day2-4-clustering-9}
Seurat::DimPlot(seu, group.by = "RNA_snn_res.0.3")
```

```{r day2-4-clustering-10}
...
```{r day2-4-clustering-11}
saveRDS(seu, "day2/seu_day2-4.rds")
```

Clear your environment:

```{r day2-4-clustering-12}
#| eval: false
gc()
```
