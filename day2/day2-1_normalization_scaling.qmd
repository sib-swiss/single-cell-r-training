...
{{< downloadthis ../assets/pdf/06_normalization_scaling.pdf dname="06_normalization_scaling" label="Download the presentation" icon="filetype-pdf" >}}
...
```{r day2-1-normalization-scaling-1}
#| warning: false
#| message: false
library(Seurat)
library(glmGamPoi)
...
```{r day2-1-normalization-scaling-2}
...
```{r day2-1-normalization-scaling-3}
#| eval: false
...
```{r day2-1-normalization-scaling-4}
#| echo: false
...
```{r day2-1-normalization-scaling-5}
#| echo: false
seu <- Seurat::NormalizeData(seu,
                     normalization.method = "LogNormalize",
                     scale.factor = 10000)
...
```{r day2-1-normalization-scaling-6}
...
```{r day2-1-normalization-scaling-7}
...
```{r day2-1-normalization-scaling-8}
...
```{r day2-1-normalization-scaling-9}
...
```{r day2-1-normalization-scaling-10}
#| output: false
...
```{r day2-1-normalization-scaling-11}
#| echo: false
names(seu@assays)
```
...
```{r day2-1-normalization-scaling-12}
...
```{r day2-1-normalization-scaling-13}
dir.create("day2")
...
```{r day2-1-normalization-scaling-14}
#| eval: false
gc()
```
